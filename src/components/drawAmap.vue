...
<script>
    ...
    export default {
        ...
        components: {
            ...
            //     require(["@/components/drawAmap"], resolve)
            // }
            // AMap
        },
        watch: {
        ...
        methods:{
            ...
            checkInput() {
                if (!this.parkingName || !this.user || !this.phone || !this.areaCoord || this.areaCoord.length == 0 || !this.address || !this.country || !this.state || !this.city || !this.area) {
                    this.disable = true;
                    return;
                }
                this.disable = false;
